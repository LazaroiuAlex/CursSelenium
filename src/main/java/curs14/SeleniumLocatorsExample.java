...
public class SeleniumLocatorsExample extends BaseTest {
	 ...
	 * --> by xpath
	 * 
	 * Selenium relative locators: above, below, near, toLeftOf, toRightOf
	 * 
	 */
	@Test(priority=1)
	...
	//	action.scrollByAmount(0, 500).perform(); pentru probleme de rezolutie	
	...
	public void nameLocator() {
		...
		commentBox.sendKeys("My super duper message!"); //pentru a tasta
		//assertTrue(commentBox.isDisplayed());
	}
	...
	public void cssLocator() throws InterruptedException {
		...
		Thread.sleep(3000); //pt a vedea ce se intampla
		nameBox.clear();
		Thread.sleep(3000);
